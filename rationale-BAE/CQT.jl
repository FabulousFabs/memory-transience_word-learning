...
function Q(;b::Float64 = 1.0)
    Q::Float64 = (2^(1 / b) - 1)^(-1);
    Q;
end

function CQT(x::Vector{Float64}; f0::Int = 15, fm::Int = 8000, b::Float64 = 1.0, fs::Int = 16000)
    ...
    @fastmath for k = 1:K
        ...
        W_k_n::Vector{Float64} = hanning(N_k);
...
function CQT_spectrogram(x::Array{Float64, 1}; b::Float64 = 3.0, l::Int = 32, s::Int = 16, fs::Int = 16000)
    ...
    F, B, N = CQT_freq(b = b, fs = fs); # get descriptors
